            ...
            <div class="card">
                ...
                <div class="body table-responsive">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach ($instructors as $key => $users)
                                <tr>
                                    ...
                                    {{-- <td>
                                        @if (count($users->user->getRoleNames()) > 0)
                                            {{ $users->user->getRoleNames()[0] }}
                                        @endif
                                    </td> --}}
                                    <td>
                                        <div class="action__buttons">
                                            <a href="{{ route('instructor.edit', [$users->uuid]) }}" class="badge badge-info mr-2">
                                                <i class="zmdi zmdi-edit"></i>
                                                {{-- <img src="{{ asset('admin/images/icons/edit-2.svg') }}" alt="edit"> --}}
                                            </a>
                                            <a class="badge badge-danger delete"
                                                onclick="return confirm('Are you sure? You want to delete')"
                                                href="{{ route('instructor.delete', $users->uuid) }}">
